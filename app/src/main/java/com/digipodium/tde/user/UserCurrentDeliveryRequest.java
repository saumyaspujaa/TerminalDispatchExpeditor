...
import com.digipodium.tde.databinding.FragmentUserCurrentDeliveryRequestBinding;
...
public class UserCurrentDeliveryRequest extends Fragment {

    private FirebaseAuth auth;
    private FirebaseFirestore db;
    private FragmentUserCurrentDeliveryRequestBinding bind;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_current_delivery_request, container, false);
    }

    @Override
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        bind = FragmentUserCurrentDeliveryRequestBinding.bind(view);
    ...
    private class DeliveryAdapter extends RecyclerView.Adapter<DeliveryAdapter.Holder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull @NotNull UserCurrentDeliveryRequest.DeliveryAdapter.Holder holder, int position) {
